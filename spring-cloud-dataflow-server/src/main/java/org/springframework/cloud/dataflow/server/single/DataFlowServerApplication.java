...
import org.springframework.cloud.dataflow.server.single.config.SSLUtil;
...
@EntityScan(basePackages = {
	"org.springframework.cloud.dataflow.server.single.entity"
})
@EnableJpaRepositories(basePackages = {
	"org.springframework.cloud.dataflow.server.single.repository"
})
