...
public class ProviderRoleMapping {
	...
	public String toString() {
		return "ProviderRoleMapping{" +
			"oauthScopePrefix='" + oauthScopePrefix + '\'' +
			", rolePrefix='" + rolePrefix + '\'' +
			", groupClaim='" + groupClaim + '\'' +
			", mapOauthScopes=" + mapOauthScopes +
			", parseOauthScopePathParts=" + parseOauthScopePathParts +
			", mapGroupClaims=" + mapGroupClaims +
			", roleMappings=" + roleMappings +
			", groupMappings=" + groupMappings +
			", principalClaimName='" + principalClaimName + '\'' +
			'}';
	}
}
