...
import org.springframework.cloud.common.security.utils.ObjectUtil;
...
public class DefaultOAuth2TokenUtilsService implements OAuth2TokenUtilsService {
	...
	public OAuth2AuthorizedClient getAuthorizedClient(OAuth2AuthenticationToken auth2AuthenticationToken) {
		Object principal = auth2AuthenticationToken.getPrincipal();
		Object objUsername = ObjectUtil.getValue(principal, "attributes['username']");
		assert objUsername != null;
		final String principalName = objUsername.toString();
