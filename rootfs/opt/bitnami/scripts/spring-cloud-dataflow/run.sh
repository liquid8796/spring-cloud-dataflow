...
__run_flags=("-jar" "-Duser.home=${HOME}" "${SPRING_CLOUD_DATAFLOW_BASE_DIR}/spring-cloud-dataflow-server.jar" "--spring.config.additional-location=optional:${SPRING_CLOUD_DATAFLOW_CONF_FILE}" "$@")
